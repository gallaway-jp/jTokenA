...
*/
#ifndef MECAB_ANDROID_MECAB_H
#define MECAB_ANDROID_MECAB_H
...
enum {
    ...
    /**
     * This is an unknown word dictionary.
     */
    MECAB_UNK_DIC = 2
};
...
public:
    ...
    virtual Node **end_nodes() const            = 0;
        ...
        /**
         * Return sentence.
         * If MECAB_NBEST or MECAB_PARTIAL mode is off, the returned pointer is the same as the one set by set_sentence().
         * @return sentence
         */
