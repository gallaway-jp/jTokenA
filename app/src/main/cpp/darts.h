...
*/
#ifndef MECAB_ANDROID_DARTS_H
#define MECAB_ANDROID_DARTS_H
...
#if !defined(DARTS_ARRAY_SIZE_IS_DEFINED)
typedef DoubleArrayImpl<char, unsigned char, int,
        unsigned int> DoubleArray;
#define DARTS_ARRAY_SIZE_IS_DEFINED 1
#endif

#endif //MECAB_ANDROID_DARTS_H
